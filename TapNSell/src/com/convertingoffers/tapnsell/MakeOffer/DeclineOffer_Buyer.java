...
public class DeclineOffer_Buyer extends BaseActivity  implements OnClickListener{
	String address="N";
	ImageLoader iLoader_item = ImageLoader.getInstance();
	DisplayImageOptions options;
	
	ImageView ivItemImage,ivNewOffer,ivClose,ivBuy;
	CustomTextView tvItemName,tvDeclineText;
	String itemid="",userid="", amount="",image="",name="",offerid="",accept=""
		,noti_msg="",type = "", price="",to_id="",isbuyer="",dialog_msg="",item_price="";
	Context context;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.makeoffer_offer_decline_buy);
		...
		item_price = bundle.getString("notification_item_price");
		
		}
		
		Log.e("noti_msg", "dec_buy "+noti_msg);
		Log.e("type", "dec_buy "+type);
		Log.e("offerid", "dec_buy "+offerid);
		Log.e("price", "dec_buy "+price);
		Log.e("name", "dec_buy "+name);
		Log.e("to_id", "dec_buy "+to_id);
		Log.e("itemid", "dec_buy "+itemid);
		Log.e("image", "dec_buy "+image);
		Log.e("isbuyer", "dec_buy "+isbuyer);
		Log.e("item_price", "dec_buy "+item_price);
...
//				holder.pbimage.setIndeterminate(true);
		...
		ivNewOffer.setOnClickListener(this);
	}
	...
	public void onContentChanged() {
		...
		ivNewOffer=(ImageView)findViewById(R.id.ivNewOffer);
	...
	@TargetApi(Build.VERSION_CODES.HONEYCOMB) public void BuybtnCode() {
		...
		Log.e("item_price", "pref  "+pref.getString("CHKPrice", ""));
	Log.e("itemid", "f "+itemid);
	Log.e("to_id", "f "+to_id);
	Log.e("mItem_IdList", "f "+mItem_IdList.size());
	Log.e("item_price", "f "+item_price);
