...
public class Twitter_Handler_Login {
	...
	String image;
	Context mContext;
    public Twitter_Handler_Login(Activity context, String consumerKey,
	    String secretKey) {
	...
	new Thread() {
		...
		/*    PostItemActivity.user=user;
		   Login_Dialog_Activity.user=user;
		   HomeActivity.user =user;
		    MyAccount_Activity.user=user;*/
		    Log.i("DataTwit",""+ user.getName()+" "+user.getLocation()+" "+user.getProfileImageURL()+" "+user.getId());
	...
	//Log.i("user detail",""+ Name+" "+City+" "+image+" "+Twit_id);
	...
	new TwitterDialog_Login(context, url, listener).show();
    }
