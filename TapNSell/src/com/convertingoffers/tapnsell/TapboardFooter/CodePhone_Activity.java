...
public class CodePhone_Activity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ivTextImage.setImageDrawable(getResources().getDrawable(R.drawable.footer_enter_digit));
		ivVerifyIcon.setImageDrawable(getResources().getDrawable(R.drawable.verify_right));
		...
		case R.id.rlVerify:
			...
			if(strVaridicationCode.length()==0){
				...
				if(cd.checkConnection()){
					new PinVarificationBackTask().execute("");
				}else{
...
///
		...
		ImageView ivVerifyIcon = (ImageView) dialog.findViewById(R.id.ivVerifyIcon);
		
		TextView tvPhoneEmail= (TextView) dialog.findViewById(R.id.tvPhoneEmail);
		...
		tvText2.setVisibility(View.GONE);
		ivVerifyIcon.setImageDrawable(getResources().getDrawable(R.drawable.verify_phone_true));
		ivVerifyIcon.setVisibility(View.VISIBLE);
		
		tvPhoneEmail.setText("Great! your number \n has been verified.");
	...
	private class PinVarificationBackTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			{
				...
				JSONObject json = userFunction.VerifyPhoneCodeFunction(userid, strVaridicationCode);
				try {
...
//				ValidationSingleButton("Error in posting");
	...
	public void buttonAnimation(View v) {
		...
		RightSwipe = AnimationUtils.loadAnimation(CodePhone_Activity.this,
				R.anim.slide_left);
